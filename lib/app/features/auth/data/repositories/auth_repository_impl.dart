...
import '../model/user_local_model.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, LoginEntity>> loginByEmail(
      LoginByEmailParams params) async {
    try {
      final requestModel = LoginRequestModel.fromDomain(params);

      final user = await remoteDataSource.loginByEmail(
